...
import kotlinx.android.synthetic.main.activity_job_cards.*
...
class JobCardsActivity : AppCompatActivity(), CardStackListener {
    ...
    override fun onCardSwiped(direction: Direction) {
        ...
        if ((manager.topPosition >= adapter.itemCount-6) && (manager.topPosition % 2 == 0)){
            val cardView = findViewById<View>(R.id.itemCard)
            showMatchSuccess(iv_job_match)
        }
    ...
    fun showMatchSuccess(view: View) {
        object : CountDownTimer(2800, 1000) {
            ...
            override fun onFinish() {
                ...
                MaterialAlertDialogBuilder(this@JobCardsActivity).setPositiveButton("Aceptar", null).create().apply {
                    setTitle("Felicitaciones")
                    setMessage("Conseguiste un trabajo! La empresa se contactará contigo.")
                    show()
                }
            }
        }.start()
    ...
    private fun createSpots(): List<Spot> {
        ...
        spots.add(Spot(name = "AJE Group", city = "Desarrollador Frontend Angular", url = "https://scontent.flim5-1.fna.fbcdn.net/v/t1.0-9/26219954_1563541673766043_5443182504050549798_n.png?_nc_cat=110&_nc_oc=AQm5Rtg4kf0QpMaCVIv9ssJ0cY8nJM0feRpM1wBVxXacLMMS3gMCRkYvElWm0gvXByA&_nc_ht=scontent.flim5-1.fna&oh=773398b5686d782baebdfee7c900b040&oe=5D89C915"))
        spots.add(Spot(name = "Antamina", city = "Desarrollador Android Kotlin Junior", url = "https://is1-ssl.mzstatic.com/image/thumb/Purple114/v4/32/ad/42/32ad427d-d5ac-6d89-b369-f5af6b288dbb/AppIcon-0-1x_U007emarketing-0-0-GLES2_U002c0-512MB-sRGB-0-0-0-85-220-0-0-0-5.png/1200x630wa.png"))
